...
```
USAGE
  $ sl alias create [--config <value>] [--format plain|json|yaml] [--hostname <value>] [--note <value>] [--mode
    uuid|word]
...
_See code: [src/commands/alias/create.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/alias/create.ts)_
...
```
USAGE
  $ sl alias create-custom PREFIX SUFFIX [--config <value>] [--format plain|json|yaml] [--hostname <value>] [--note
...
_See code: [src/commands/alias/create-custom.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/alias/create-custom.ts)_
...
```
USAGE
  $ sl alias custom PREFIX SUFFIX [--config <value>] [--format plain|json|yaml] [--hostname <value>] [--note
    <value>] [--mailbox-ids <value>] [--name <value>]
...
_See code: [src/commands/alias/delete.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/alias/delete.ts)_
...
```
USAGE
  $ sl alias list [--all] [--config <value>] [--disabled | --pinned | --enabled] [--format plain|json|yaml]
    [--page <value>]
...
_See code: [src/commands/alias/list.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/alias/list.ts)_
...
```
USAGE
  $ sl alias ls [--all] [--config <value>] [--disabled | --pinned | --enabled] [--format plain|json|yaml]
    [--page <value>]
...
```
USAGE
  $ sl alias options [--config <value>] [--custom] [--domain <value>] [--format plain|json|yaml] [--hostname
...
_See code: [src/commands/alias/options.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/alias/options.ts)_
...
```
USAGE
  $ sl alias search QUERY [--all] [--config <value>] [--disabled | --pinned | --enabled] [--format
    plain|json|yaml] [--page <value>]
...
_See code: [src/commands/alias/search.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/alias/search.ts)_
...
```
USAGE
  $ sl alias update ALIAS-ID [--config <value>] [--format plain|json|yaml] [--disable-pgp] [--mailbox-id <value>]
    [--mailbox-ids <value>] [--name <value>] [--note <value>] [--pinned]
...
_See code: [src/commands/alias/update.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/alias/update.ts)_
...
_See code: [src/commands/config.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/config.ts)_
...
_See code: [src/commands/login.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/login.ts)_
...
_See code: [src/commands/logout.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/logout.ts)_
...
_See code: [src/commands/whoami.ts](https://github.com/KennethWussmann/simplelogin-cli/blob/v0.3.3/src/commands/whoami.ts)_
<!-- commandsstop -->
